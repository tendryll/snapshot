...
public class WeatherService {
  ...
  public WeatherInfo get(String stationId) {
      ...
      addData(weatherInfo.getData(), "barometricPressure", jsonContent.get().getValue("/properties/barometricPressure")
          .asJsonObject());
      addData(weatherInfo.getData(), "seaLevelPressure", jsonContent.get().getValue("/properties/seaLevelPressure")
          .asJsonObject());
      addData(weatherInfo.getData(), "visibility", jsonContent.get().getValue("/properties/visibility").asJsonObject());
